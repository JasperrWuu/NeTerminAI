  ...
  return (
    <div className="settings-view">
      ...
      <section className="settings-card">
        ...
        <div className="settings-row"><span><strong>运行方式</strong><small>OpenAI 兼容 API 或本地 CLI</small></span><Select<AiSettings["providerMode"]> ariaLabel="运行方式" className="settings-select" onChange={(providerMode) => onChange({ providerMode })} options={[{ label: "兼容 API", value: "api" }, { label: "本地进程", value: "process" }]} value={settings.providerMode} /></div>
